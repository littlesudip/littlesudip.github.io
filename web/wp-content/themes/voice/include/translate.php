...
$vce_translate = array(
	...
	'read_more' => array('option_title' => 'Read more', 'translated' => __('Read more', THEME_SLUG), 'option_desc' => 'Read more button title'),
	...
	'written_by' => array('option_title' => 'Written by', 'translated' => __('Written by', THEME_SLUG), 'option_desc' => 'Used for author link with image on single posts'),
	...
	'latest_posts' => array('option_title' => 'Latest articles', 'translated' => __('Latest articles', THEME_SLUG), 'option_desc' => 'Used for box title if home page in reading setting is set to "latest posts"'),
	'next_page' => array('option_title' => 'Next', 'translated' => __('Next', THEME_SLUG), 'option_desc' => 'Next button title for paginated post'),
	'prev_page' => array('option_title' => 'Prev', 'translated' => __('Prev', THEME_SLUG), 'option_desc' => 'Previous button title for paginated post'),
	'page_of' => array('option_title' => 'Page %s of %s', 'translated' => __('Page %s of %s', THEME_SLUG), 'option_desc' => 'Used on paginated post navigation'),
	...
	'cancel_reply_link' => array('option_title' => 'X', 'translated' => __('X', THEME_SLUG), 'option_desc' => 'Comments area cancel reply link text'),
	...
	'comment_name' => array('option_title' => 'Name', 'translated' => __('Name', THEME_SLUG), 'option_desc' => 'Comment form name field tilte'),
