...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
  	...
  	<?php 
	if ( function_exists( 'autorepair_contact_info' ) ) {
		autorepair_contact_info(); 
	}?>
	...
	<div class="autorepair-banner-area">
		...
		<?php if( is_front_page() ) :
				...
				if ( $banner_type == 'video' && is_front_page() ) :
					autorepair_banner_video();
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					autorepair_banner_slider();
				else :
					autorepair_banner_background();
				endif;
			else : ?>
			<div class="header-background other-header">
				...
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() : autorepair_get_breadcrumb() );
						}else{
							autorepair_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
